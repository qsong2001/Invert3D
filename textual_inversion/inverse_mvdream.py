...
if not hasattr(pl.loggers, 'TestTubeLogger'):
    pl.loggers.TestTubeLogger = pl.loggers.TensorBoardLogger
    print("Patched TestTubeLogger to use TensorBoardLogger")
...
def load_model_from_config_mv(config, ckpt, verbose=False):
    print(f"Loading model from {ckpt}")
    pl_sd = torch.load(ckpt, map_location="cpu")
    # sd = pl_sd["state_dict"]
    config.model.params.ckpt_path = ckpt
...
if __name__ == "__main__":
    ...
    try:
        ...
        # model
        print("opt.placeholder_string:",opt.placeholder_string)
        ...
        if opt.actual_resume:
            model = load_model_from_config_mv(config, opt.actual_resume)

            # from mvdream.pipeline_mvdream import MVDreamPipeline
            # model = MVDreamPipeline.from_pretrained(
